 ...
 *    desc   : 菜单选择框
 */
public final class FriendMenuDialog {
    ...
    public static final class Builder
        ...
        public Builder(FragmentActivity activity) {
            super(activity);
            setContentView(R.layout.dialog_menu_friend);
    ...
    private static final class MenuAdapter extends MyRecyclerViewAdapter<Object> {
        ...
        final class ViewHolder extends MyRecyclerViewAdapter.ViewHolder {
            ...
            public void onBindView(int position) {
                ...
                if (position == 0){
                    mTextView.setTextColor(getResources().getColor(R.color.colorConfirm));
                }else if (position == 1){
                    mTextView.setTextColor(getResources().getColor(R.color.colorCancel));
                }
            }
        }
    }
