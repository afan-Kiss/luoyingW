 ...
 * @date 2019/11/18
 */
public class CreatGroupAdapter extends BaseQuickAdapter<FriendListModel.AllArrayBean, BaseViewHolder> {

    private Context mContext;

    public CreatGroupAdapter(int layoutResId, List<FriendListModel.AllArrayBean> data, Context context) {
