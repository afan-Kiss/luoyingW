package com.hjq.demo.mine_chenmo.chatui.widget;
...
public class RecordButton extends AppCompatButton {
    ...
    private String mFile =  getContext().getFilesDir()+ "/";
...
//        } else {
//        }
        mRecorder = RecordManager.getInstance();
        mRecorder.changeFormat(RecordConfig.RecordFormat.MP3);
        mRecorder.changeRecordConfig(mRecorder.getRecordConfig().setSampleRate(16000));
        mRecorder.changeRecordConfig(mRecorder.getRecordConfig().setEncodingConfig(AudioFormat.ENCODING_PCM_8BIT));
...
//        mRecorder.setAudioEncoder(MediaRecorder.AudioEncoder.AMR_NB);
        ...
        mRecorder.changeRecordDir(mFile);
         try {
            //mRecorder.prepare();
            mRecorder.start();
        }catch (Exception e){
       ...
       /* mThread = new  ObtainDecibelThread();
        mThread.start();*/
        mRecorder.setRecordResultListener(new RecordResultListener() {
            @Override
        ...
        mRecorder.setRecordSoundSizeListener(new RecordSoundSizeListener() {
            @Override
