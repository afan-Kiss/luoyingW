...
import com.hjq.demo.util.DensityUtil;
...
public class MultiImageView extends LinearLayout {
	...
	// 照片的Url列表
	private List<DynamicImageBean> imagesList;
	...
	public void setList(List<DynamicImageBean> lists) throws IllegalArgumentException{
		if(lists==null){
	...
	private ImageView createImageView(int position, final boolean isMultiImage) {
		DynamicImageBean photoInfo = imagesList.get(position);
		...
		imageView.setId(photoInfo.getPath().hashCode());
