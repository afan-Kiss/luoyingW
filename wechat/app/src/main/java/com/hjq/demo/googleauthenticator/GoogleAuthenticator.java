...
/**
 * Created by zhangrenwei on 2019-11-23 20:13.
 */
...
//    public static final String SEED = "YWRzZmFmZGFkZnMxMjM0NQ==";
    ...
    //1、执行测试代码中的“genSecret”方法，将生成一个KEY（用户为testuser），URL打开是一张二维码图片。
    public static String genSecret(String name, String pwd) {
        String secret = GoogleAuthenticator.generateSecretKey();
        //GoogleAuthenticator.getQRBarcodeURL("testuser","testhost", secret);
        GoogleAuthenticator.getQRBarcodeURL(name,
                pwd, secret);
        Log.d("asdfjkagsdfjahgsdfjh", "genSecret: " + GoogleAuthenticator.getQRBarcodeURL(name,
                pwd, secret));
        return secret;
    }
    ...
    public static String generateSecretKey() {
        ...
        try {
            ...
            sr.setSeed(Base64.decode(SEED,Base64.NO_WRAP));
    ...
    public static String check_code(String secret, long timeMsec) {
        Base32 codec = new Base32();
    ...
    public boolean check_code(String secret, long code, long timeMsec) {
        ...
        for (int i = -window_size; i <= window_size; ++i) {
            ...
            try {
                hash = verify_code(decodedKey, t + i);
                Log.d("asdfjkagsdfjahgsdfjh", "check_code: " + hash);
            } catch (Exception e) {
