...
/** 
 * DAO for table "GROUP_MESSAGE_ENTITY".
*/
public class GroupMessageEntityDao extends AbstractDao<GroupMessageEntity, Long> {

    public static final String TABLENAME = "GROUP_MESSAGE_ENTITY";

    /**
     * Properties of entity GroupMessageEntity.<br/>
    ...
    public static class Properties {
        ...
        public final static Property GroupCard = new Property(11, String.class, "groupCard", false, "GROUP_CARD");
        public final static Property UserCard = new Property(12, String.class, "userCard", false, "USER_CARD");
    }


    public GroupMessageEntityDao(DaoConfig config) {
        super(config);
    }
    
    public GroupMessageEntityDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GROUP_MESSAGE_ENTITY\" (" + //
                ...
                "\"GROUP_CARD\" TEXT," + // 11: groupCard
                "\"USER_CARD\" TEXT);"); // 12: userCard
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GROUP_MESSAGE_ENTITY\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, GroupMessageEntity entity) {
        stmt.clearBindings();
        ...
        if (groupCard != null) {
            stmt.bindString(12, groupCard);
        }
 
        String userCard = entity.getUserCard();
        if (userCard != null) {
            stmt.bindString(13, userCard);
        }
    }

    @Override
    protected final void bindValues(SQLiteStatement stmt, GroupMessageEntity entity) {
        stmt.clearBindings();
    ...
    @Override
    public GroupMessageEntity readEntity(Cursor cursor, int offset) {
        GroupMessageEntity entity = new GroupMessageEntity( //
            ...
            cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11), // groupCard
            cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12) // userCard
        );
        return entity;
    }
     
    @Override
    public void readEntity(Cursor cursor, GroupMessageEntity entity, int offset) {
        ...
        entity.setGroupCard(cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11));
        entity.setUserCard(cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12));
     }
    
    @Override
    protected final Long updateKeyAfterInsert(GroupMessageEntity entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(GroupMessageEntity entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(GroupMessageEntity entity) {
