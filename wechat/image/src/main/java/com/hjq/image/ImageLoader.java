...
public final class ImageLoader {
    ...
    public static void loadImage(final RelativeLayout layout,String path, Context mConext) {
    ...
    public static void startslide(Context context){
        Glide.with(context).resumeRequests();
    }

    public static void stopslide(Context context){
